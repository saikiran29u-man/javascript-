...
//console.log(Array.isArray("saikiran")) //-->  isArray() method will works with static method.

//console.log(Array.from('saikiran')) //--> from() method converts string into an arrray.
